<div class="w-1/6 h-screen bg-white">
    ...
    <nav class="mt-10 px-2">
        ...
        <a class="flex items-center  mt-5 py-2 px-4 rounded-lg {{ request()->is('admin/product_type') ? 'bg-green-900 text-gray-100' : 'text-gray-600 hover:bg-gray-200 hover:text-green-900' }}" href="{{route('product_type.index')}}">
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="mx-4 font-medium truncate">Product Type</span>
        </a>
